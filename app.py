...
def frequency_analysis(phrase, text):
    ...
    words = text.split()
    frequency = dict()
    stop_list = ['of', 'by', 'then', 'from', 'i', 'to', 'him', 'he', 'she', 'her', 'their', 'them', 'our', 'the', 'and', 'retrieved', 'in', 'a', 'are', 'as', 'is', 'or', 'for', 'on', 'with', 'this', 'isbn', 'have', 'that', 'such', 'also', 'other', 'be', 'some', 'they', 'which', 'not', 'more', 'all', 'but', 'most', 'at', 'it', 'an', 'out', 'your', 'article', 'make', 'including', 'generally', 'may', 'its', 'many', 'info', 'than', 'was', 'has', 'called', 'well', 'often', 'sometimes', 'one', 'those', 'do', 'since', 'belong', 'contains', 'between', 'either', 'while', 'being', 'after', 'only', 'name', 'both', 'were', 'had', 'you', 'if', 'would', 'been', 'any', 'when', 'can', 'us', 'during', 'will', 'there', 'around', 'even', 'into', 'so', 'first', 'just', 'two', 'three', 'four', 'five', 'six', 'seven', 'eight', 'yes', 'no', 'use', 'used', 'these', 'against', 'became', 'who'] # to be continued
    for word in words:
        if not word.isalpha():
            continue
        if phrase in word:
